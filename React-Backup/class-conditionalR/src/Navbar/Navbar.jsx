    ...
    return <nav className="navbar navbar-dark bg-dark navbar-expand-lg">
        ...
        <div className="ml-auto">
            <ul className="navbar-nav ">
                <li className="nav-list"><Link className="nav-link" to="/password">Password</Link></li>
                <li className="nav-list"><Link className="nav-link" to="/sms">SMS</Link></li>
                <li className="nav-list"><Link className="nav-link" to="/condition">Cond Rendering</Link></li>
